    ...
    public class SamplesViewModel : ViewModelBase
    {
            ...
            List<Product> list2 = new()
      {
        ...
        public List<int> ExceptProductSalesMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.Select(p => p.ProductID).Except(sales.Select(s => s.ProductID))
                    .ToList();
        ...
        public List<Product> IntersectByQuery()
        {
            ...
            list = (from prod in products
                    select prod)
                    .IntersectBy(from c in colors select c, p => p.Color)
                    .ToList();
        ...
        public List<Product> IntersectByProductSalesQuery()
        {
            ...
            list = (from prod in products
                    select prod)
                    .IntersectBy<Product, int>(from sale in sales select sale.ProductID, p => p.ProductID)
                    .ToList();
        ...
        public List<Product> IntersectByProductSalesMethod()
        {
            ...
            // Write Method Syntax Here
            list = products
                .IntersectBy<Product, int>(sales.Select(s => s.ProductID), p => p.ProductID)
                .ToList();
